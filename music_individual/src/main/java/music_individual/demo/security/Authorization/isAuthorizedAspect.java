package music_individual.demo.security.Authorization;
...
public class isAuthorizedAspect {
    private final static Logger LOGGER = LoggerFactory.getLogger(isAuthorizedAspect.class);

    @Pointcut("@annotation(music_individual.demo.security.Authorization.isAuthorized)")
    public void annotatedMethod() {
    }

    @Pointcut("@within(music_individual.demo.security.Authorization.isAuthorized)")
