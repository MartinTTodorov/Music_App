package music_individual.demo.security.Authentication;
...
public class AuthenticationRequestFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain)
        ...
        try {
            AccessToken accessTokenDTO = accessTokenManager.decode(accessToken);
    ...
    private void setupSpringSecurityContext(AccessToken accessToken) {
        ...
        authorities.add(new SimpleGrantedAuthority(SPRING_SECURITY_ROLE_PREFIX + accessToken.getRole()));
